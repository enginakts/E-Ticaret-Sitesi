...
public static class SeedDatabase
{
    public static async void Initialize(IApplicationBuilder app)
    {
        ...
        {
            var customer = new AppUser { Name = "Engin Aktaş", UserName = "enginakt", Email = "engin@gmail.com" };
            var admin = new AppUser { Name = "Kaan Deneme", UserName = "kaandenek", Email = "kaan@gmail.com" };
